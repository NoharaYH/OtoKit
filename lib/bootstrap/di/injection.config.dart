...
import '../../infrastructure/storage/repositories_impl/transfer_repository_impl.dart'
    as _i39;
import '../../infrastructure/storage/secure/storage_service.dart' as _i465;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i465.StorageService>(
      () => _i465.StorageService(gh<_i558.FlutterSecureStorage>()),
    );
