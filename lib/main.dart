...
import 'application/transfer/transfer_provider.dart'; // exports TransferController + TransferProvider typedef
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => getIt<MusicLibraryController>()),
